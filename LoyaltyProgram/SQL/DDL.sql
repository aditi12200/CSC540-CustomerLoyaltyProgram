...
ALTER TRIGGER "T_REWARD_ID" ENABLE;

CREATE TABLE WALLET_GIFTCARD(WALLET_ID VARCHAR2(20), GIFT_CARD_CODE NUMBER(20), EXPIRY_DATE DATE, PRIMARY KEY(GIFT_CARD_CODE), FOREIGN KEY(WALLET_ID) REFERENCES WALLET(WALLET_ID));
...
ALTER TRIGGER "T_GIFTCARD" ENABLE;
...
AFTER UPDATE OF CUMULATIVE_PTS ON WALLET
    FOR EACH ROW
DECLARE
